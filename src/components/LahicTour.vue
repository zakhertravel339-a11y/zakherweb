      ...
      <div class="row">
        ...
        <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
          ...
          <div class="inner-column">
            ...
            <div class="sec-title title-tour">
              ...
              <span class="title" style="color: #FFA500; font-weight: 600;">Tour to village of artisans – Lahij</span>
            ...
            <div class="">
              ...
              <ol class="dot-list">
                ...
                <li><span class="fw-bold">Duration of the tour:</span> 1 Day (9-10 hours)</li>

                <li><span class="fw-bold">Itinerary:</span> Baku – Shemakha – Lahij – Baku</li>

                <li><span class="fw-bold">Category:</span> Private tour</li>

                <li><span class="fw-bold">Length of the route:</span> approximately 180 km (one way)</li>
        ...
        <div class="image-column col-lg-6 col-md-12 col-sm-12">
          ...
          <div class="inner-column wow fadeInLeft">
            ...
            <figure class="image-1"><a href="#" class="lightbox-image" data-fancybox="images"> <img src="../assets/images/lahic.jpeg" alt="Handshake">
            </a></figure>
